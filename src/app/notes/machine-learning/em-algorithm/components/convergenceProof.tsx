...
export default function ConvergenceProof() {
  return (
    <Section heading="Proof of Convergence">
      ...
      <div>
        We saw that the for any given value of <InlineMath math="\theta" /> and any distribution over <InlineMath math="z" />, our log-likelihood <InlineMath math="\ell(\theta) = \log p(x;\theta)" />{" "}
        is always greater than the <InlineMath math="\text{ELBO}(x; Q, \theta)" />.
      </div>
      <div>
