...
export default function PCA() {
  return (
    <Section heading="Principal Component Analysis" title="Dimensionality Reduction">
      ...
      <div>
        We can now use Lagrange optimization to find the unit vector <InlineMath math="u" /> that maximizes the variance. And it turns out the variance is maximized when <InlineMath math="u" /> is the
        eigenvector of our symmetric matrix <InlineMath math="\Sigma" />.
      </div>
