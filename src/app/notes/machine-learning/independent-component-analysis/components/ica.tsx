...
export default function ICA() {
  return (
    <Section title="Independent Component Analysis">
      ...
      <div>
        Repeated observations of the data give us a set of training samples <InlineMath math="\{x^{(1)}, \ldots, x^{(n)} \}" /> and we want to find the unmixing matrix <InlineMath math="W = A^{-1}" />{" "}
        that allows us to reconstruct the sources.
      </div>
      <div>
      ...
      <div>
        We suppose that the distribution of each source <InlineMath math="s_j" /> is given by <InlineMath math="p_{s}(s_j)" /> and is independent of the other sources. Therefore the joint distribution
        of the sources is:
      </div>
      <div>
