      ...
      <Content>
        ...
        <div className="flex flex-col list-disc pl-2 gap-2">
          ...
          <li>
            ...
            symmetric in nature. Therefore, if our unmixing matrix <InlineMath math="W" /> is multiplied by a rotation or reflection matrix <InlineMath math="R" />, there is no way for us to know
            about it.
