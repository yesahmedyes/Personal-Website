...
export default function Introduction() {
  return (
    <Section title="Decision Trees" heading="Introduction">
      ...
      <div>
        One example of this is the ID3 algorithm. In this algorithm, we start at the root node and at each step select the feature <InlineMath math="x_j" /> that best separates the data and minimizes
        the impurity. We then recurse on the left and right subsets defined by this split until we can no longer split the data.
      </div>
