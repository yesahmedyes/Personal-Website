...
export default function Bagging() {
  return (
    <Section heading="Bagging">
      ...
      <div>
        Note that doing this means that our datasets are not independent and identically distributed and according to the Law of Large Numbers is no longer guaranteed. In practice, however, doing this
        still helps us reduce the variance to some extent.
      </div>
