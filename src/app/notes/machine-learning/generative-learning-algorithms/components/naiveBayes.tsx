...
export default function NaiveBayes() {
  return (
    <Section heading="Naive Bayes">
      ...
      <div>
        However, there is a problem with this approach. If any of the <InlineMath math="p(x_j|y = 1)" />, then our prediction will be 0. This happens if we don&apos;t have any training example for
        which a particular <InlineMath math="x_j" /> is <InlineMath math="1" />.
      </div>
