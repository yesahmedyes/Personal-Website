...
export default function GDA() {
  return (
    <Section title="Generative Learning Algorithms" heading="Gaussian Discriminant Analysis">
      <div>
        If we want to classify between cats and dogs, discrimnative learning algorithms try to learn a hyperplane that separates the two classes directly. Generative learning algorithms, try to learn
        a model for what cats look like and a separate model to learn what dogs look like.
      </div>
      <div>
      ...
      <div>
        In Gaussian Discriminant Analysis (GDA), we assume that each of <InlineMath math="p(x \mid y)" /> follows a multivariate gaussian distribution with unique mean but a shared covariance matrix.
      </div>
      <div className="flex flex-col">
