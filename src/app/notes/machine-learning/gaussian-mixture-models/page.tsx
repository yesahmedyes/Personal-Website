    ...
    <MainWithSidebar>
      <Section title="Gaussian Mixture Models">
        <Content>
          ...
          <div>
            When we plug in the equations for the gaussian distribution, this takes a form very similar to the softmax function. So in the <InlineMath math="E" /> step, we find our estimated
            probability distribution for what value <InlineMath math="z^{(i)}" /> should take for each <InlineMath math="x^{(i)}" />.
          </div>
        </Content>
        <Derivation>
          <DerivationContent>
        ...
        <Content>
          ...
          <div>
            In the <InlineMath math="M" /> step, we update the value of our parameters to maximize the <InlineMath math="\text{ELBO}" /> for which it is equal to{" "}
            <InlineMath math="p(x; \mu, \Sigma)" /> for our current values of <InlineMath math="\phi, \mu, \Sigma" />.
          </div>
        </Content>
      </Section>
    </MainWithSidebar>
