...
export default function ComplexityBounds() {
  return (
    <Section heading="Complexity Bounds">
      ...
      <div>
        This means that as n increases, the probability of the true error being close to the empirical error is bounded by a bigger value. Whereas, as we increases the number of hypotheses in our set,
        this probability is actually bounded by a smaller value.
      </div>
      <div>
      ...
      <div>
        We see that if we want the probability of &quot;the true error being within <InlineMath math="\gamma" /> to the empirical error for all hypothesiss under our consideration&quot; to be at least{" "}
        <InlineMath math="1 - \delta" />, our <InlineMath math="n" /> needs to be atleast as large as:
      </div>
      <div>
        {" "}
      ...
      <div>
        With a probability of <InlineMath math="1 - \delta" />, the true error of our selected hypothesis is less than or equal to the true error of the best hypothesis + some term that depends on the
      ...
      <div>This is similar to what we saw in the Bias-Variance tradeoff. As we increase the complexity of our model, variance increases and the potential for our model to overfit also increases.</div>
