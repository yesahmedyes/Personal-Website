...
export default function BiasVarianceTradeoff() {
  return (
    <Section title="Learning Theory" heading="Bias-Variance Tradeoff">
      ...
      <div>
        Also, let <InlineMath math="h_{avg}(x) = \mathbb{E}\left[h_s(x)\right]" /> be the &quot;average model&quot; - the model obtained by drawing an infinite number of datasets, training on them,
        and averaging their predictions on <InlineMath math="x" />.
      </div>
