  ...
  return (
    <Section title="Generalization" heading="Bias-Variance Tradeoff">
      <Subsection>
        <Content>
          <div>
            Let <InlineMath math="S = \left\{ \left( x^{(i)}, y^{(i)} \right) \right\}_{i=1}^{n}" /> be our set of training examples that are related using the following equation:
          </div>
          <div>
        ...
        <Content>
          ...
          <div>
            In reality, however, we see a double descent phenomenon wherein the test error starts to decrease again at the point where the number of parameters <InlineMath math="d" /> are
            approximately equal to the number of training examples <InlineMath math="d" />. This is called the over-parameterization regime.
          </div>
        </Content>
      </Subsection>
    </Section>
